...
function FoodDetails() {
  ...
  //   {
  //     imageSrc: Burger1,
  //     navigateTo: '/homedetails/fooddetails/cart',
  //     textMeal: 'Burger Bistro',
  //     textRestaurant: 'Rose garden'
  //   },
  //   {
  //     imageSrc: Burger1,
  //     navigateTo: '/homedetails/fooddetails/cart',
  //     textMeal: 'Smokin Burger',
  //     textRestaurant: ''
  //   },
  //   {
  //     imageSrc: Burger1,
    ...
    <div className=" py-3 px-3">
      ...
      <div className="  grid grid-cols-2 gap-4">
        ...
        {product.map((item: any) => (
          <CartFood imageSrc={Burger1} navigateTo={"//"} textMeal={item.name}  textPrice={item.categoryId} textRestaurant={item.description} />
        ))}
      </div>
      <p>Open Restaurant</p>
      <CardRestaurant
